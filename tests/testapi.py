...
def test_predict():
    ...
    # Données de test
    test_data = {"ca_total": 15000.0, "nb_commandes": 320}
    ...
    response = requests.post(
        f"{BASE_URL}/predict", data=json.dumps(test_data), headers=headers
    )
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(
            "Assurez-vous que l'API est en cours d'exécution (uvicorn src.api:app --reload)"
        )
